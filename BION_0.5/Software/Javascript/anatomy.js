...
function open_node( id ) {
    ...
    document.main.ana_click_id.value = id;
...
function focus_name( name ) {
    ...
    document.main.ana_root_name.value = name;
...
function expand_node( nid, cid ) {
    ...
    document.main.ana_click_id.value = nid;
    document.main.ana_col_index.value = cid;
...
function delete_column( id ) {
    ...
    document.main.ana_col_index.value = id;
...
function save_terms() {
    ...
    document.main.ana_info_type.value = "ana";
    document.main.ana_info_key.value = "ana_terms_tsum";

    document.main.page.value = "ana";
    document.main.submit();
}

function delete_selection( id ) {
    
    document.main.ana_info_index.value = id;
